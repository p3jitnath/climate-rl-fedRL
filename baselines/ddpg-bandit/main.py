...
obs = fixed_obs = np.zeros(
    (1, np.array(envs.single_observation_space.shape).prod())
)  # stateless
for global_step in range(1, args.total_timesteps + 1):
    ...
    if global_step < args.learning_starts:
        ...
        with torch.no_grad():
            actions = actor(
                torch.Tensor(fixed_obs).to(device)
    ...
    rb.add(fixed_obs, fixed_obs, actions, rewards, terminations, infos)
