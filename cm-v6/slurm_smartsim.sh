...
#SBATCH --output=/gws/nopw/j04/ai4er/users/pn341/climate-rl-f2py/cm-v6/slurm/ray_slurm_%j.out
#SBATCH --error=/gws/nopw/j04/ai4er/users/pn341/climate-rl-f2py/cm-v6/slurm/ray_slurm_%j.err
#SBATCH --nodes=3
